...
class JLLatLngTest implements ModelTest {
        ...
        void testDistanceCalculation_lng(double pointALat, double pointALng, double pointBLat, double pointBLng,
                        int distance) {
                JLLatLng pointA = JLLatLng.builder()
                                .lat(pointALat)
                                .lng(pointALng)
                ...
                Assertions.assertTrue(
                                Math.abs(distance - Math.round(pointA.distanceTo(pointB) / 1000)) < DISTANCE_ERROR_KM);
        }
}

...
public class JLMapView extends JLMapController {
    ...
    private void initialize() {
        ...
        webView.getEngine().onStatusChangedProperty().addListener((observable, oldValue, newValue) -> log
                .debug(String.format("Old Value: %s\tNew Value: %s", oldValue, newValue)));
        webView.getEngine().onErrorProperty().addListener((observable, oldValue, newValue) -> log
                .debug(String.format("Old Value: %s\tNew Value: %s", oldValue, newValue)));
        ...
        WebConsoleListener.setDefaultListener((view, message, lineNumber, sourceId) -> log
                .error(String.format("sid: %s ln: %d m:%s", sourceId, lineNumber, message)));
        ...
        webView.getEngine()
                .load(String.format("file:%s%s", Objects.requireNonNull(index).getAbsolutePath(),
                        mapOption.toQueryString()));
